...
def gamerule():
    ...
    def botcross():
        if (tiles[8] == 0):
            tiles[8] = 2
        elif (tiles[8] != 0) and (tiles[4] == 0):
            tiles[4] = 2
        elif (tiles[4] != 0) and (tiles[3] == 0) and (tiles[8] !=0):
            tiles[3] = 2
        elif (tiles[3] != 0) and (tiles[5] == 0) and (tiles[8] !=0) and (tiles[4] != 0):
            tiles[5] = 2
        elif (tiles[3] != 0) and (tiles[5] != 0) and (tiles[8] !=0) and (tiles[4] != 0) and (tiles[6] == 0):
            tiles[6] = 2
        elif tiles[0] == 0 and (tiles[8] != 0 and tiles[4] != 0 and tiles[3] != 0 and tiles[5] != 0 and tiles[6] != 0):
            tiles[0] = 2
        elif tiles[1] == 0 and (tiles[8] != 0 and tiles[4] != 0 and tiles[3] != 0 and tiles[5] != 0 and tiles[6] != 0 and tiles[0] != 0):
            tiles[1] = 2
        elif tiles[7] == 0 and (tiles[8] != 0 and tiles[4] != 0 and tiles[3] != 0 and tiles[5] != 0 and tiles[6] != 0 and tiles[0] != 0 and tiles[1] != 0 and tiles[2] !=0):
            tiles[7] = 2
        elif tiles[2] == 0 and (tiles[8] != 0 and tiles[4] != 0 and tiles[3] != 0 and tiles[5] != 0 and tiles[6] != 0 and tiles[0] != 0 and tiles[1] != 0):
            tiles[2] = 2
    def botcircle():
        if (tiles[8] == 0):
            tiles[8] = 1
    ...
    if start == True and botpl == True and circlepl == True:
        if steps == 1:
            ...
            if (tiles[8] == 0):
                tiles[8] = 2
            elif (tiles[8] != 0) and (tiles[4] == 0):#8435601
                tiles[4] = 2
            elif (tiles[4] != 0) and (tiles[3] == 0) and (tiles[8] !=0):
                tiles[3] = 2
            elif (tiles[3] != 0) and (tiles[5] == 0) and (tiles[8] !=0) and (tiles[4] != 0):
        ...
        if steps == 2:
            ...
            if tiles[0] == 0:
                tiles[0] = 1
            elif (tiles[0] != 0) and (tiles[2] == 0):
                tiles[2] = 1
            elif (tiles[0] != 0) and (tiles[2] != 0) and (tiles[6] == 0):
                tiles[6] = 1
            steps = 5
        elif steps == 6:
            if (tiles[8] == 0):
...
while True:
    ...
    gamerule()
    drawWindow()
    print(start, botpl, circlepl, steps)
    clock.tick(FPS)
